...
# ---------------------------------------------------------------------------- #
# LabelEncoder Options
# ---------------------------------------------------------------------------- #
_C.MODEL.LABELENCODER = CN()
_C.MODEL.LABELENCODER.EMB_DIM = 2048
_C.MODEL.LABELENCODER.N_HEADS = 8
_C.MODEL.LABELENCODER.N_TRANS_LAYERS = 12
_C.MODEL.LABELENCODER.WEIGHT = "/home/mdisk1/zhanggege/Textspotting/UDiffText/checkpoints/encoders/LabelEncoder/epoch=19-step=7820_initial.ckpt"
_C.MODEL.LABELENCODER.MAX_LEN = 25